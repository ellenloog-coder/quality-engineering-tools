const CACHE_NAME = "blendex-labs-shell-v13";
...
const PRECACHE_URLS = [
  ...
  "./index.html",
  "./offline.html",
  "./manifest.webmanifest?v=20260731-4",
  "./assets/css/styles.css?v=20260803-2",
  "./assets/js/navigation.js?v=20260716-6",
  "./assets/js/ai-assistant.js?v=20260730-1",
  "./assets/js/i18n.js?v=20260803-1",
  "./assets/js/pwa.js?v=20260717-1",
  "./assets/brand/blendex-labs-symbol.png",
  "./assets/icons/favicon-32.png?v=20260731-4",
  "./assets/icons/apple-touch-icon.png?v=20260731-4",
  "./assets/icons/icon-192.png?v=20260731-4",
  "./assets/icons/icon-512.png?v=20260731-4",
  "./assets/icons/maskable-192.png?v=20260731-4",
  "./assets/icons/maskable-512.png?v=20260731-4"
];
